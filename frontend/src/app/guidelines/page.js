        ...
        <div className="text-center space-y-8 mb-20 animate-in fade-in duration-500">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight text-foreground max-w-4xl mx-auto leading-[1.1]">
              KTU Activity Points{" "}
              <span className="text-foreground/60 font-light">2024 Scheme</span>
            </h1>
            <p className="text-sm md:text-base text-foreground/75 max-w-2xl mx-auto font-light leading-relaxed">
              The official guide for B.Tech, B.Des, BBA & BCA Students to
              navigate the Mandatory Student Activity (MSA) requirements.
            </p>
          </div>
          ...
          <div className="bg-secondary/5 border border-border/50 backdrop-blur-xl rounded-[2.5rem] overflow-hidden shadow-2xl">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-border/30 bg-secondary/5">
                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-foreground/60">
                      Category of Admission
                    </th>
                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-foreground/60 border-x border-border/30 text-center">
                      Total Points Required
                    </th>
                    <th className="px-8 py-6 text-[10px] font-bold uppercase tracking-widest text-foreground/60 text-center">
                      Min per Group (I, II, III)
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-border/20">
                  <tr className="hover:bg-secondary/5 transition-colors">
                    <td className="px-8 py-6">
                      <span className="text-lg font-display font-medium text-foreground/80">
                        Regular Degree
                      </span>
                      <p className="text-[10px] text-foreground/30 uppercase tracking-widest font-bold mt-1">
                        4 Year Programme
                      </p>
                    </td>
                    ...
                    <td className="px-8 py-6 text-center">
                      <span className="text-lg font-display font-medium text-foreground/60">
                        40 Points
                      </span>
                    </td>
                  </tr>
                  <tr className="hover:bg-secondary/5 transition-colors">
                    ...
                    <td className="px-8 py-6 border-x border-border/30 text-center">
                      <span className="text-3xl font-display font-bold text-foreground/50">
                        90
                      </span>
                    </td>
                    <td className="px-8 py-6 text-center">
                      <span className="text-lg font-display font-medium text-foreground/40">
                        30 Points
                      </span>
                    </td>
                  </tr>
                  <tr className="hover:bg-secondary/5 transition-colors">
                    ...
                    <td className="px-8 py-6 text-center">
                      <span className="text-lg font-display font-medium text-foreground/30">
                        20 Points
                      </span>
                    </td>
                  </tr>
            ...
            <div className="md:hidden divide-y divide-border/20">
              {[
                ...
                { 
                  name: "Lateral Entry", 
                  detail: "3 Year Programme", 
                  total: "90", 
                  min: "30",
                  opacity: "text-foreground/50"
                },
                { 
                  name: "PwD Students", 
                  detail: "Inclusive Admissions", 
                  total: "60", 
                  min: "20",
                  opacity: "text-foreground/40"
                }
              ].map((row, i) => (
                <div key={i} className="p-6 space-y-4 hover:bg-secondary/5 transition-colors">
                  <div className="flex justify-between items-start">
                    <div>
                      <h4 className="text-lg font-display font-medium text-foreground/80">
                        {row.name}
                      </h4>
                    ...
                    <div className="text-right">
                      <span className={`text-3xl font-display font-bold ${row.opacity}`}>
                        {row.total}
                      </span>
                      <p className="text-[9px] font-bold uppercase tracking-tighter text-foreground/30">
                        Total Pts
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center justify-between p-3.5 bg-background/40 rounded-2xl border border-border/30">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-foreground/40">
                      Min per Group
                    </span>
                    <span className="text-sm font-display font-semibold text-foreground/60">
                      {row.min} Points
                    </span>
                  </div>
                </div>
              ...
              <ul className="space-y-6">
                ...
                <li className="flex gap-4 items-start">
                  ...
                  <p className="text-sm text-foreground/75 leading-relaxed font-light">
                    ...
                    <span className="text-foreground font-medium">levels</span>{" "}
                    (National, State, Zonal, College).
                  </p>
                </li>
                <li className="flex gap-4 items-start">
                  <div className="mt-1.5 w-1.5 h-1.5 rounded-full bg-foreground/40 shrink-0" />
                  <p className="text-sm text-foreground/75 leading-relaxed font-light">
                    Submission of fraudulent documents leads to{" "}
                    <span className="text-foreground font-medium">
                      permanent points forfeiture
                    </span>
                    .
                  </p>
                </li>
