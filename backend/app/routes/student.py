...
import uuid
from app.util.helper import fetchRuleBook, maxCheck_meritLevelValidation, validateActivity, highLevel_winOverride, cluster_cap
...
async def create_submission(
    ...
    try:
        ...
        db.storage.from_("activity-certificates").upload(file_path, file_content)
